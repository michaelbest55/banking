  ...
  return (
    <section className="auth-form">
      <header className="flex flex-col gap-5 md:gap-8">
        <Link href="/" className="cursor-pointer item-center flex gap-1">
          <Image
            src="/icons/logo.svg"
            width={34}
            height={34}
        ...
        <div className='flex flex-col gap-1 md:gap-3'>
          <h1 className="text-24 lg:test-36
        font-semibold text-gray-900">
            ...
            <p className="text-16 font-normal text-gray-600">
              {user ? 'Link your account to get started' : 'Enter your details below'}
            </p>
          </h1>
        </div>
      </header>
              ...
              {type === 'sign-up' && (
                <>
                  ...
                  <CustomInput
                    ...
                    title="Address" placeholder="Enter your current address"
                  />
                  <CustomInput
                    control={form.control} name="city"
                    title="City" placeholder="Enter your city"
                  />
                  <div className="flex gap-4">
                    <CustomInput
                      control={form.control} name="state"
                      title="State" placeholder="ex: NY"
                    />
                    <CustomInput
                      control={form.control} name="postalCode"
                      title="Postal Code" placeholder="ex: 11101"
                    />
                  </div>
                  <div className="flex gap-4">
                    <CustomInput
                    ...
                    <CustomInput
                      ...
                      title="SSN" placeholder="ex: 123-45-6789"
                    />
                  </div>
